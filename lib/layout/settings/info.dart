  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
        children: [
          child('Mobile Number', Icons.phone,'111111',1),
          separate(),
          child('Name', Icons.edit,name,2),
          separate(),
          child('Gender ', Icons.transgender_outlined,gender,3),
          separate(),
          child('Birthdate', Icons.calendar_today_outlined,bDate.month.toString(),0),
        ],
      ),
    )
    );
        ...
        if(x==2){
          showDialog(
            ...
            builder: (BuildContext context){
              return AlertDialog(
                backgroundColor: Colors.white,
                title: Center(child:Text("Your Name",)),
          ...
          showDialog(
            ...
            builder: (BuildContext context){
              return AlertDialog(
                  ...
                  title: Center(child:Text("Your Gender",)),
                  content: Column(
                    children: [
                      ListTile(

...
class SupportScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    child: Column(
      children: [
        Center(child: Text('Support' , style: TextStyle(fontWeight: FontWeight.bold),)),
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Icon(Icons.arrow_forward_ios_outlined , color: Colors.orange,size: 20,)
                                ],
                              ),
                            ],
                          ),
                                  ...
                                  children: [
                                    ...
                                    Container(
                                        child: Image(
                                          ...
                                          height: 180,
                                          image:
                                          NetworkImage('https://images-na.ssl-images-amazon.com/images/I/21M0l6AEgaL.png'),
                                        ))
                                  ],
                                ),
                              ),

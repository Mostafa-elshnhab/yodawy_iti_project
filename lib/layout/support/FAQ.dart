...
class _FaqScreenState extends State<FaqScreen> {
    ...
    var email = ()=>{ TextButton(onPressed: (){}, child: Text('sara@gmail.com')) }  ;
    ...
    return Scaffold(
              ...
              AppBar(
                ...
                title: Container(
                  // width: double.infinity ,
                    child: Column(
                      children: [
                        Center(child: Text('FAQ' , style: TextStyle(fontWeight: FontWeight.bold),)),
      ...
      body: SingleChildScrollView(
         child: Container(
           child: Column(
             children: [
               Accordion('Why is ordering online Yodawy easier than calling the pharmacy?',
           ...
           'Easily track your orders. Save your favorite items. Reorder items you frequently need. And much, much more'),
              ...
              Accordion('I have a prescription from the doctor .Can I still order from Yodawy?',
               ...
               Accordion('Can I use my health insurance if I am ordering from Yodawy?',
               ...
               Accordion('Can I use a promo code on medication products?',
              ...
              Accordion('How can I partner with Yodawy?', 'Please email us at hello@yodawy.com') ,

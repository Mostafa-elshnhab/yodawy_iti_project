      ...
      body: SingleChildScrollView(
        child: Container(
          child: Column(
            children: [
              Accordion(
                  'Is Esteshara certified from the ministry of health?',
                  'All the doctors of estshara are certified from'
                      'the ministry of health .'),
              Accordion(
                  'Can you provide sick notes and Prescriptions after the phone consultation?',
                  'Estshara\' doctor will send you a recommendation '
                      'after the consultations'),
              Accordion(
                  'What are the symptoms that Esteshara\' doctors deal with?',
                  'For cold , flu , cough , irritation , nausea ,fever , sinuses ,'
                      'some skin conditions, men and women health '),
              Accordion('What are the available Specialties?',
                  'Family medicine and internal medicine ,'),
              Accordion(
                  'What you help with Esteshara in emergency '
                      'cases?',
                  'No , We cannot use Esteshara in emergency cases , '
                      'You can refer to the ambulance or emergency spots'),
              Accordion(
                  'is there a place that we can visit ?',
                  'You can consult estshara\'doctors through'
                      'the application only .'),
              Accordion(
                  'Are there doctors available to answer the consultation ? And are they qualified?',
              ...
              Accordion(
                  'Can you help with sending the medicines needed after consultation?',
